...
function Navbar(){
    ...
    // Este useEffect hace que cuando clikeas fuera o un enlace del navbar, se cierre el menu lateral
    useEffect(() => {
    ...
    return(
        <nav>
            <div className={`wrapper ${navbarVisible && !responsiveNavVisible ? "blur-nav" : ""}`}>
                <motion.div 
                    className="brand"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
